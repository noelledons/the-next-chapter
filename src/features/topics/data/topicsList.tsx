...
export const topicsList: Topic[] = [
  {
    id: 'career',
    title: 'Career',
    description: 'Gain clarity about your work, ambitions, and next professional move.',
    icon: (
  ...
  },
  {
    ...
    description: 'Understand what you need from your relationships and what direction feels right.',
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Reflect on your physical, emotional, and mental wellbeing.',
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    id: 'money',
    title: 'Finances',
    description: 'Understand your financial position and make more confident money decisions.',
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Reconnect with your values, identity, confidence, and sense of purpose.',
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Creating a calm, beautiful space that supports your growth and daily joy.',
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
